...
type OrderSubmitReq struct {
	...
	AddressBookId uint32                 `protobuf:"varint,2,opt,name=address_book_id,json=addressBookId,proto3" json:"address_book_id,omitempty"`
...
func (x *OrderSubmitReq) GetAddressBookId() uint32 {
	if x != nil {
...
var file_order_bitjump_order_proto_rawDesc = []byte{
	...
	0x01, 0x28, 0x0d, 0x52, 0x0d, 0x61, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x42, 0x6f, 0x6f, 0x6b,
