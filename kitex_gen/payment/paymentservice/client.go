...
type Client interface {
	...
	Notify(ctx context.Context, Req *payment.NotifyReq, callOptions ...callopt.Option) (r *payment.NotifyResp, err error)
}
...
func (p *kPaymentServiceClient) Notify(ctx context.Context, Req *payment.NotifyReq, callOptions ...callopt.Option) (r *payment.NotifyResp, err error) {
	ctx = client.NewCtxWithCallOptions(ctx, callOptions)
