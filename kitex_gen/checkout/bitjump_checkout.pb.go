...
func (x *CheckoutResp) Reset() {
	*x = CheckoutResp{}
	if protoimpl.UnsafeEnabled {
		mi := &file_bitjump_checkout_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*CheckoutResp) Descriptor() ([]byte, []int) {
	return file_bitjump_checkout_proto_rawDescGZIP(), []int{2}
}
...
var file_bitjump_checkout_proto_rawDesc = []byte{
	...
	0x68, 0x65, 0x63, 0x6b, 0x6f, 0x75, 0x74, 0x52, 0x65, 0x73, 0x70, 0x22, 0x00, 0x42, 0x31, 0x5a,
	0x2f, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x31, 0x32, 0x33, 0x35,
...
var file_bitjump_checkout_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
...
func file_bitjump_checkout_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_bitjump_checkout_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
