...
var serviceMethods = map[string]kitex.MethodInfo{
	...
	"GetAddressInfo": kitex.NewMethodInfo(
		getAddressInfoHandler,
		newGetAddressInfoArgs,
		newGetAddressInfoResult,
		false,
		kitex.WithStreamingMode(kitex.StreamingUnary),
	),
}
...
func getAddressInfoHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	switch s := arg.(type) {
	case *streaming.Args:
		st := s.Stream
		req := new(address.GetAddressInfoReq)
		if err := st.RecvMsg(req); err != nil {
			return err
		}
		resp, err := handler.(address.AddressService).GetAddressInfo(ctx, req)
		if err != nil {
			return err
		}
		return st.SendMsg(resp)
	case *GetAddressInfoArgs:
		success, err := handler.(address.AddressService).GetAddressInfo(ctx, s.Req)
		if err != nil {
			return err
		}
		realResult := result.(*GetAddressInfoResult)
		realResult.Success = success
		return nil
	default:
		return errInvalidMessageType
...
func newGetAddressInfoArgs() interface{} {
	return &GetAddressInfoArgs{}
}

func newGetAddressInfoResult() interface{} {
	return &GetAddressInfoResult{}
}

type GetAddressInfoArgs struct {
	Req *address.GetAddressInfoReq
}

func (p *GetAddressInfoArgs) FastRead(buf []byte, _type int8, number int32) (n int, err error) {
	if !p.IsSetReq() {
		p.Req = new(address.GetAddressInfoReq)
	}
	return p.Req.FastRead(buf, _type, number)
}

func (p *GetAddressInfoArgs) FastWrite(buf []byte) (n int) {
	if !p.IsSetReq() {
		return 0
	}
	return p.Req.FastWrite(buf)
...
func (p *GetAddressInfoArgs) Size() (n int) {
	if !p.IsSetReq() {
		return 0
	}
	return p.Req.Size()
...
func (p *GetAddressInfoArgs) Marshal(out []byte) ([]byte, error) {
	if !p.IsSetReq() {
		return out, nil
	}
	return proto.Marshal(p.Req)
...
func (p *GetAddressInfoArgs) Unmarshal(in []byte) error {
	msg := new(address.GetAddressInfoReq)
	if err := proto.Unmarshal(in, msg); err != nil {
		return err
	}
	p.Req = msg
...
var GetAddressInfoArgs_Req_DEFAULT *address.GetAddressInfoReq

func (p *GetAddressInfoArgs) GetReq() *address.GetAddressInfoReq {
	if !p.IsSetReq() {
		return GetAddressInfoArgs_Req_DEFAULT
	}
	return p.Req
}

func (p *GetAddressInfoArgs) IsSetReq() bool {
	return p.Req != nil
}

func (p *GetAddressInfoArgs) GetFirstArgument() interface{} {
	return p.Req
}

type GetAddressInfoResult struct {
	Success *address.GetAddressInfoResp
}

var GetAddressInfoResult_Success_DEFAULT *address.GetAddressInfoResp

func (p *GetAddressInfoResult) FastRead(buf []byte, _type int8, number int32) (n int, err error) {
	if !p.IsSetSuccess() {
		p.Success = new(address.GetAddressInfoResp)
	}
	return p.Success.FastRead(buf, _type, number)
}

func (p *GetAddressInfoResult) FastWrite(buf []byte) (n int) {
	if !p.IsSetSuccess() {
		return 0
	}
	return p.Success.FastWrite(buf)
...
func (p *GetAddressInfoResult) Size() (n int) {
	if !p.IsSetSuccess() {
		return 0
	}
	return p.Success.Size()
...
func (p *GetAddressInfoResult) Marshal(out []byte) ([]byte, error) {
	if !p.IsSetSuccess() {
		return out, nil
	}
	return proto.Marshal(p.Success)
...
func (p *GetAddressInfoResult) Unmarshal(in []byte) error {
	msg := new(address.GetAddressInfoResp)
	if err := proto.Unmarshal(in, msg); err != nil {
		return err
	}
	p.Success = msg
...
func (p *GetAddressInfoResult) GetSuccess() *address.GetAddressInfoResp {
	if !p.IsSetSuccess() {
		return GetAddressInfoResult_Success_DEFAULT
	}
	return p.Success
}

func (p *GetAddressInfoResult) SetSuccess(x interface{}) {
	p.Success = x.(*address.GetAddressInfoResp)
}

func (p *GetAddressInfoResult) IsSetSuccess() bool {
	return p.Success != nil
}

func (p *GetAddressInfoResult) GetResult() interface{} {
	return p.Success
}
...
func (p *kClient) GetAddressInfo(ctx context.Context, Req *address.GetAddressInfoReq) (r *address.GetAddressInfoResp, err error) {
	var _args GetAddressInfoArgs
	_args.Req = Req
