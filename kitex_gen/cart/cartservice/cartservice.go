...
var DeleteItemResult_Success_DEFAULT *cart.EmptyCartResp
...
func (p *DeleteItemResult) GetSuccess() *cart.EmptyCartResp {
	if !p.IsSetSuccess() {
...
func (p *kClient) DeleteItem(ctx context.Context, Req *cart.DeleteItemReq) (r *cart.EmptyCartResp, err error) {
